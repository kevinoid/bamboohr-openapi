...
/**
 * Transformer to remove empty arrays from anyOf and oneOf schemas.  Empty
 * arrays are returned in place of empty objects by the BambooHR API in some
 * places (e.g. TimeOffRequest.notes) and anyOf/oneOf are not currently
 * supported by code generators (except for inheritance).
 */
